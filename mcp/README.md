...
3. Run the exact exchange command shown by the page. It follows this form:
   ...
   ```bash
   npx -y kassinao-mcp@1.0.9 exchange --stdin --url https://mcp.your-instance.example
   ```
...
3. Rode o comando exato mostrado pela página. Ele segue este formato:
   ...
   ```bash
   npx -y kassinao-mcp@1.0.9 exchange --stdin --url https://mcp.sua-instancia.example
   ```
