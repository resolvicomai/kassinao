      ...
      items: [
        {
          ...
          fallback: '7',
          description: {
            pt: 'Teto para áudio sem transcrição; com transcrição pronta o áudio é apagado na hora.',
            en: 'Ceiling for audio without a transcript; once the transcript is ready the audio is deleted immediately.',
          },
        },
        {
...
<div class="docs-shell">
  ...
  <main class="docs-main" id="conteudo"><div class="docs-main-inner">
    ...
    <section class="doc-section" id="mcp" data-doc-section data-keywords="mcp connector tools token exchange revoke read only instance url">
      ...
      <div class="mcp-tools"><article class="mcp-tool"><code>kassinao_list_meetings</code><p>${esc(T('Lista reuniões acessíveis.', 'Lists accessible meetings.'))}</p></article><article class="mcp-tool"><code>kassinao_pending_actions</code><p>${esc(T('Lista ações e prazos históricos da ata, sem estado de conclusão.', 'Lists historical minutes actions and deadlines without completion status.'))}</p></article><article class="mcp-tool"><code>kassinao_search_meetings</code><p>${esc(T('Busca texto dentro dos limites da API.', 'Searches text within API limits.'))}</p></article><article class="mcp-tool"><code>kassinao_who_said</code><p>${esc(T('Busca atribuição por conta do Discord.', 'Searches attribution by Discord account.'))}</p></article><article class="mcp-tool"><code>kassinao_get_meeting</code><p>${esc(T('Abre os dados autorizados de uma reunião.', 'Returns authorized meeting data.'))}</p></article></div>
