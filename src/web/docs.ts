...
<div class="docs-shell">
  ...
  <main class="docs-main" id="conteudo"><div class="docs-main-inner">
    ...
    <section class="doc-section" id="local" data-doc-section data-keywords="local source docker build compose localhost quickstart">
      ...
      <div class="callout"><strong>${esc(T('Quickstart exige Docker Engine 28.0.0+ e Docker Compose 2.36.0+.', 'Quickstart requires Docker Engine 28.0.0+ and Docker Compose 2.36.0+.'))}</strong><p>${esc(T('O router depende de interfaces nomeadas e seleção determinística de gateway; versões anteriores são recusadas antes de subir.', 'The router depends on named interfaces and deterministic gateway selection; older versions are rejected before startup.'))}</p></div>
