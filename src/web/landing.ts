...
<script type="application/ld+json">${JSON.stringify({ '@context': 'https://schema.org', '@type': 'SoftwareApplication', name: 'Kassinão', applicationCategory: 'BusinessApplication', operatingSystem: 'Docker, Linux', description, url: site.canonicalUrl, softwareHelp: `${config.baseUrl}${site.links.docs}`, codeRepository: site.links.github, license: 'https://www.gnu.org/licenses/agpl-3.0.html' }).replace(/</g, '\\u003c')}</script>
</head>
<body>
